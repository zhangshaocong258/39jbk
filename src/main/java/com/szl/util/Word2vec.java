...
public class Word2vec {
    public static void main(String[] args) throws Exception {
        ...
        word2vec.loadGoogleModel(new File("E:\\word2vec\\vec5.bin"));
        System.out.println(word2vec.distance("心悸"));
        System.out.println(word2vec.distance("气短"));
    }
     ...
     * @throws IOException
     */
    public void loadGoogleModel(File file) throws IOException {
