...
<head>
    ...
    <style>
        .box {
            background: url("<c:url value='/static/img/个人信息s.png'/>");
            width: 970px;
            height: 785px;
            /*display: table-cell;*/
            /*!* 水平居中 *!*/
...
<div style="margin:0 auto; margin-top: 80px; width:970px">
    <div class="box">
        <form class="form-horizontal" action="select" method="get">
            <div style="position:absolute;left:284px;top:180px">
            ...
            <div style="position:absolute;left:284px;top:278px">
                <select name="age" value="age" class="form-control" style="width:160px;">
                    <option>未选择</option>
                    <option>1岁</option>
                    <option>2岁</option>
                    <option>3岁</option>
            ...
            <div style="position:absolute;left:284px;top:358px">
            ...
            <div style="position:absolute;left:290px;top:500px">
